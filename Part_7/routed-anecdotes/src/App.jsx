...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/anecdotes')
    props.broadcastMessage(`New anecdote ${content} created!`)
  }
...
const App = () => {
  ...
  const anecdote = anecdoteMatch ?
    anecdotes.find(anecdote => anecdote.id === Number(anecdoteMatch.params.id)) : null
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/create' element={<CreateNew addNew={addNew} broadcastMessage={broadcastMessage} />} />
